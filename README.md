...
- `CF_R2_PUBLIC_BASE_URL` optional public R2/custom-domain base used for Microsoft Office document iframe preview (`.doc/.docx`, `.xls/.xlsx`, `.ppt/.pptx`, plus macro-enabled variants)
