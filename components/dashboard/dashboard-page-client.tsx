...
const dashboardHeaderCopy = {
  owned: {
    title: "Ваше дерево",
    description: "Откройте конструктор для изменений, перейдите в просмотр для проверки структуры или вернитесь к доступным деревьям ниже."
  },
  invited_only: {
    title: "Доступные деревья",
    description: "Сначала показываем деревья, к которым у вас уже есть доступ. Собственное дерево можно создать ниже, когда оно действительно понадобится."
  },
  empty: {
    title: "Создайте первое дерево",
    description: "После создания вы сразу попадете в конструктор и продолжите работу уже из своего dashboard."
  }
} as const;
